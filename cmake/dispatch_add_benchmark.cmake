function(dispatch_add_benchmark benchmark_name N M T output_prefix)
  ...
  add_custom_command(
    ...
    COMMAND python3 ${CMAKE_SOURCE_DIR}/benchmarks/generate_benchmark.py ${N} ${M} ${T} --in_filename ${CMAKE_SOURCE_DIR}/benchmarks/string_dispatch.cpp.empy --out_filename ${output}
  ...
  add_custom_command(
    ...
    COMMAND python3 ${CMAKE_SOURCE_DIR}/benchmarks/run_benchmarks.py ${CMAKE_BINARY_DIR}/${full_name} 100 --output ${CMAKE_BINARY_DIR}/${full_name}_results.csv
